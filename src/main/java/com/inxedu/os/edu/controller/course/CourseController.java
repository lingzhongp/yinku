...
//            query.setTeacherId(queryCourse.getTeacherId());
//            System.out.println(query);//query为null
...
//            	System.out.println(course.getCourseId() == courseId);
//            	System.out.println(courseList.size());
            	for(CourseDto tempCoursedto : courseList){
//            		System.out.println("进来了");
//            		System.out.println(tempCoursedto);
